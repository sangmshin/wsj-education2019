...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
  ...
  <p style="max-width: 600px; margin: 0 auto; overflow: hidden; text-align: center;">
  <strong class="test" style="font-size: 25px; font-family: 'Chronicle Display';">You have a school-sponsored WSJ membership</strong><br><br>
  <p style="border-top: 1px #000 solid; max-width: 600px; margin: 0 auto;"></p><p></p>
  </p>
  <br />
   <p style="font-family: 'Whitney SSm'; text-align: center; max-width: 600px; margin: 0 auto;">Click the link below to activate:
  </p>
  <br />
  </div>
  <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #0CBCB1; color: #fff; ">
        ...
        <?php if (!$modCode) : ?>
          <a onClick="fbtrack1()" href="<?php echo the_content(); ?>" target="_blank" style="color: #fff;"><h1 style="text-align: center"><?php the_title(); ?></h1> </a>   
          <?php else : ?>
          <a onClick="fbtrack1()" href="<?php echo the_content().$modCode; ?>" target="_blank" style="color: #fff;"><h1 style="text-align: center"><?php the_title(); ?></h1> </a>
        <?php endif; ?>
        </div>
        <br />
  ...
  <?php endwhile; else: ?>
  <p  style="max-width: 500px; margin: 0 auto; display: block; overflow: hidden; text-align: center;"><strong id="test" style="font-size: 25px; font-family: 'Chronicle Display';">It looks like your school does not offer a sponsored WSJ Membership.</strong><br><br>
  <p style="border-top: 1px #000 solid; max-width: 600px; margin: 0 auto;"></p><p></p>
  </p>
   <!-- <p style="font-family: 'Whitney'; text-align: left; max-width: 600px; margin: 0 auto;">Sorry!</p> -->
  <br /><br />
    <p style="font-size: 18px;"><?php _e('To take advantage of our exclusive student offer for only <br />$1 a week, click <a target="_blank" href="https://subscribe.wsj.com/studentmembership" style="color:#0CBCB1; font-weight:600;">here.</a>'); ?></p>
  <?php endif; ?>
</div>
</div>
