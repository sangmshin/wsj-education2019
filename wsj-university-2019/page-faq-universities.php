                ...
                <div class="row d-sm-none">
                    <div class="col font__rm text-center mt-2 mb-5">
                        <select id="themes-select" class="text-center">
                            <option value="students" <?php if( wsju_page_slug() == 'faq-students' ) { echo "selected";} ?> >
                                STUDENTS
                            </option>
                            <option value="professors" <?php if( wsju_page_slug() == 'faq-professors' ) { echo "selected";} ?> >
                                PROFESSORS
                            </option>
                            <option value="universities" <?php if( wsju_page_slug() == 'faq-universities' ) { echo "selected";} ?> >
                                UNIVERSITIES
                            </option>
                        </select>
                    </div>
