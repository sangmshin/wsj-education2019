  ...
  <div class="container-fluid main-inner">
        ...
        <div class="row text-center search__form-wrapper">
          <form role="search" method="get" id="searchform" onsubmit="" class="searchform" action="../">
            <div>
              <input type="text" class="inputfield text-center input" value="" name="s" id="s" placeholder="Enter School Name" autofocus>
              <input type="hidden" name="user_type" id="user_type" value="<?php echo wsju_user_type( $_GET["user_type"] ); ?>">
              ...
              <!-- <input type="hidden" name="mod_code" id="mod_code" value="search-a"> -->
